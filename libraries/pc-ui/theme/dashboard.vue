    ...
    <u-multi-layout-item>
        <u-multi-layout>
            <u-multi-layout-item style="width: 200px;">
              <u-sidebar :router="false" value="dashboard" style="--sidebar-item-icon-color-selected: var(--brand-primary)">
            ...
            <u-multi-layout-item>
              <u-linear-layout type="flex" direction="horizontal" gap="normal" class="dashbord_page_layout">
                <u-linear-layout type="flex" direction="vertical" gap="normal" class="main">
                  <u-panel>
                    <u-linear-layout type="flex" direction="vertical" gap="normal">
                      <u-alert type="info" title="Informational Notes  信息提示"></u-alert>
                      <u-linear-layout type="flex" direction="horizontal" gap="none">
                  ...
                  <u-panel title="资源监控">
                    <u-linear-layout type="flex" direction="horizontal" gap="none" alignment="center">
                      <div class="progress-item">
                        <u-circular-progress :percent="65.2" size="large"></u-circular-progress>
                        <div class="text">CPU用量</div>
                      </div>
                      <div class="divider"></div>
                      <div class="progress-item">
                        <u-circular-progress :percent="65.3" size="large"></u-circular-progress>
                        <div class="text">内存用量</div>
                      </div>
                      <div class="divider"></div>
                      <div class="progress-item">
                        <u-circular-progress :percent="96.2" size="large"></u-circular-progress>
                  ...
                  <u-panel>
                    <u-tabs appear="line">
                      <u-tab title="租户资源">
                        <u-linear-layout type="flex" direction="vertical" alignment="stretch" gap="normal">
                          <u-linear-layout type="flex" direction="horizontal" gap="small">
                            <u-select placeholder="请选择状态" value="">
                              <u-select-item value="wait">待审批</u-select-item>
                              <u-select-item value="passed">通过</u-select-item>
                              <u-select-item value="approving">审批中</u-select-item>
                              <u-select-item value="unpassed">未通过</u-select-item>
                            </u-select>
                            <u-button color="primary" text="查询"></u-button>
                          </u-linear-layout>
                          <u-linear-layout type="flex" direction="vertical" alignment="stretch">
                            <u-table-view
                              :data-source="[
                                { name: '资源名称', desc: '资源描述', status: 'passed' },
                                { name: '资源名称', desc: '资源描述', status: 'wait' },
                                { name: '资源名称', desc: '资源描述', status: 'unpassed' },
                                { name: '资源名称', desc: '资源描述', status: 'passed' },
                                { name: '资源名称', desc: '资源描述', status: 'passed' },
                              ]"
                            >
                              <u-table-view-column title="资源名称" field="name" width="25%"></u-table-view-column>
                              <u-table-view-column title="资源描述" field="desc" width="25%"></u-table-view-column>
                              <u-table-view-column title="状态" field="status" width="25%">
                                <template #cell="scope">
                                  <u-label v-if="scope.value === 'passed'" color="success" text="通过"></u-label>
                                  <u-label v-if="scope.value === 'unpassed'" text="未通过"></u-label>
                                  <u-label v-if="scope.value === 'wait'" color="warning" text="待审批"></u-label>
                                </template>
                              </u-table-view-column>
                              <u-table-view-column title="操作" field="id" width="25%">
                                <template #cell>
                ...
                <u-linear-layout type="flex" direction="vertical"  gap="normal" class="side">
                  ...
                  <u-panel title="公告">
                    <u-linear-layout type="flex" direction="vertical" gap="normal">
                      <u-linear-layout type="flex" direction="horizontal" gap="small">
                        <u-label class="flex-shrink" color="error" text="置顶"></u-label>
                        <div class="flex-fill-text">新版本V3.6上线</div>
                      </u-linear-layout>
                      <u-linear-layout type="flex" direction="horizontal" gap="small">
                        <u-label class="flex-shrink" color="primary" text="最新"></u-label>
                        <div class="flex-fill-text">网易内部通过低代码打造一网易内部通过低代码打造一...</div>
                      </u-linear-layout>
                      <u-linear-layout type="flex" direction="horizontal" gap="small">
                        <u-label class="flex-shrink" color="primary" text="最新"></u-label>
