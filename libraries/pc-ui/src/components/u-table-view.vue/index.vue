...
<div :class="$style.root" ref="root" :border="border"
    ...
    <u-table-columns-render :tableMetaList="tableMetaList" :visibleColumnVMs="visibleColumnVMs" :visibleTableHeadTrArr="visibleTableHeadTrArr"></u-table-columns-render>
...
import UTableColumnsRender from './index-render.vue';
