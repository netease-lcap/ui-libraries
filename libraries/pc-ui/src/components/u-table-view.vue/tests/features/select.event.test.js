...
describe('u-table-view.vue events test', () => {
  it('should type radio column $emit select', async () => {
    ...
    expect(wrapper.emitted('select')[0][0].index).toEqual(index);
    expect(wrapper.emitted('select')[0][0].item).toEqual(dataSource[index]);
    expect(wrapper.emitted('select')[0][0].selectedItem).toEqual(dataSource[index]);
    expect(wrapper.emitted('select')[0][0].value).toEqual(dataSource[index].name);
  });

  it('should selectable $emit select', async () => {
    const handleSelect = jest.fn();
