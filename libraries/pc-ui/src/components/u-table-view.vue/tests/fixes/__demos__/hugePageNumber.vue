<template>
    <u-linear-layout direction="vertical">
        <u-table-view striped :data-source="load" pagination :page-size="pageSize" :page-number="pageNumber" :show-sizer="true" :page-size-options="[10,20,50]" ref="tableview">
...
const mockService = {
    loadList(offset, limit) {
        ...
        return mockRequest({
            total: 100000,
            data: mockData(offset, offset + limit),
        });
    },
};
