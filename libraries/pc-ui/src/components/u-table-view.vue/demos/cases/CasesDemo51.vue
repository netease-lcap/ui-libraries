...
<u-linear-layout direction="vertical">
    <u-text>分页连续编号</u-text>
    <u-table-view striped :data="data" pagination :page-size="10">
        <u-table-view-column title="序号" :autoIndex="true" type="index" width="100px"></u-table-view-column>
    ...
    <u-text>分页不连续</u-text>
    <u-table-view striped :data="data" pagination :page-size="10">
        <u-table-view-column title="序号" type="index" width="100px"></u-table-view-column>
        <u-table-view-column title="用户名" field="name" width="15%"></u-table-view-column>
        <u-table-view-column title="手机号码" field="phone" width="20%"></u-table-view-column>
        <u-table-view-column title="地址" field="address"></u-table-view-column>
        <u-table-view-column title="最近登录时间" field="loginTime" formatter="placeholder | date" width="20%"></u-table-view-column>
