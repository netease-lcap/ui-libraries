...
export default {
    ...
    methods: {
        ...
        onMouseMoving(e) {
            // 拖拽约束
            const next = (this.constraint || this.defaultConstraint)(manager); // 设置位置
        ...
        drag() {
            this.$emit(
                'drag',
                Object.assign(
                    { originVM: this, sourceEl: this.sourceEl },
                    manager,
                ),
                this,
            );
        ...
        dragEnd() {
            ...
            this.$emit(
                'dragend',
                Object.assign({ originVM: this, sourceEl }, manager),
                this,
            );
            if (manager.transferEl) {
                if (this.$slots.transfer || this.transfer === 'clone')
                    manager.transferEl.parentElement.removeChild(
                        manager.transferEl,
                    );
