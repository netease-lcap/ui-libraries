...
namespace nasl.ui {
  ...
  export class VanFlex extends ViewComponent {
    constructor(options?: Partial<VanFlexOptions>) {
      super();
    }
  }

  export class VanFlexOptions extends ViewComponentOptions {
    @Prop<VanFlexOptions, 'mode'>({
      group: '样式属性',
      title: '布局模式',
      description: '设置布局模式',
      bindHide: true,
