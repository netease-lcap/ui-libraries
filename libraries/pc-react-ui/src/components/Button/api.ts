...
namespace nasl.ui {
  ...
  export class Button extends ViewComponent {
    constructor(options?: Partial<ButtonOptions>) {
      super();
    }
  }

  export class ButtonOptions extends ViewComponentOptions {
    // @Prop({
    //   title: '路由链接',
    ...
    @Prop({
      ...
      setter: {
        concept: 'EnumSelectSetter',
        options: [{ title: '大' }, { title: '正常' }, { title: '小' }],
      },
    })
    ...
    @Prop({
      ...
      setter: {
        concept: 'EnumSelectSetter',
        options: [{ title: '方形' }, { title: '圆角' }, { title: '圆形' }],
      },
    })
