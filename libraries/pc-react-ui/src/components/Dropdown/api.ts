...
namespace nasl.ui {
  ...
  export class Dropdown<T, V> extends ViewComponent {
    constructor(options?: Partial<DropdownOptions<T, V>>) {
      super();
    }
  }

  export class DropdownOptions<T, V> extends ViewComponentOptions {
    // @Prop<DropdownOptions<T, V>, 'hasDataSource'>({
    //   group: '数据属性',
    //   title: '数据源配置',
    //   bindHide: true,
    //   setter: {
    ...
    //   },
    //   onChange: [{ clear: ['dataSource', 'dataSchema', 'textField', 'toField', 'iconField', 'valueField', 'parentField', 'linkTypeField', 'targetField'] }],
    // })
    ...
    // @Prop<DropdownOptions<T, V>, 'toField'>({
    //   group: '数据属性',
    //   title: '跳转链接字段',
    ...
    // @Prop<DropdownOptions<T, V>, 'parentField'>({
    //   group: '数据属性',
    //   title: '父级值字段',
    ...
    // @Prop<DropdownOptions<T, V>, 'value'>({
    //   group: '数据属性',
    //   title: '选中值',
    //   description: '当前选中的值',
    //   sync: true,
