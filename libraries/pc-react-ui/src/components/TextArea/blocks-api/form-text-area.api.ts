...
namespace nasl.ui {
  ...
  export class FormTextArea extends ViewComponent {
    constructor(options?: Partial<FormTextAreaOptions & FormItemOptions>) {
      super();
    }
  }

  export class FormTextAreaOptions extends ViewComponentOptions {
    @Prop({
      group: '主要属性',
      title: '占位符',
