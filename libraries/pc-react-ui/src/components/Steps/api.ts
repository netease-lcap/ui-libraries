...
namespace nasl.ui {
  ...
  export class Steps<T> extends ViewComponent {
    @Method({
      title: 'undefined',
      description: '重新加载数据',
    })
  ...
  export class StepsOptions<T> extends ViewComponentOptions {
    @Prop({
      group: '数据属性',
      title: '数据源',
    ...
    // })
    // onBeforeSelect: (event: { value: nasl.core.Integer; oldValue: nasl.core.Integer; item: T }) => any;

    // @Event({
    //   title: '选择后',
    //   description: '选择某一步骤时触发',
    // })
    // onSelect: (event: { value: nasl.core.Integer; oldValue: nasl.core.Integer; item: T }) => any;
  ...
  export class StepsItemOptions extends ViewComponentOptions {
    ...
    //   description: '正常显示，但禁止选择/输入',
    //   tooltipLink:
    //     'https://help.lcap.163yun.com/99.%E5%8F%82%E8%80%83/40.%E9%A1%B5%E9%9D%A2IDE/30.%E9%A1%B5%E9%9D%A2%E7%BB%84%E4%BB%B6/05.PC%E9%A1%B5%E9%9D%A2%E5%9F%BA%E7%A1%80%E7%BB%84%E4%BB%B6/07.%E9%80%89%E6%8B%A9%E5%99%A8/170.%E6%AD%A5%E9%AA%A4%E6%9D%A1.html',
    //   docDescription: '是否只读，非只读的情况下可以选择',
    //   setter: {
    //     concept: 'SwitchSetter',
    //   },
