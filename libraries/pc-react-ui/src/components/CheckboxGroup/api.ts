...
namespace nasl.ui {
  ...
  export class CheckboxGroupOptions<T, V, C> extends ViewComponentOptions {
    ...
    // @Prop<checkboxGroupOptions<T, V, C>, 'checkAll'>({
    //   group: '主要属性',
    //   title: '全选控制',
    //   description: '是否进行全选',
    //   setter: {
    ...
    //   },
    //   onChange: [{ clear: ['min', 'max'] }],
    // })
    // checkAll: nasl.core.Boolean = false;

    // @Prop<checkboxGroupOptions<T, V, C>, 'checkAllText'>({
    //   group: '主要属性',
    //   title: '全选展示内容',
    ...
    // @Prop<checkboxGroupOptions<T, V, C>, 'checkAllDisplay'>({
    //   group: '主要属性',
    //   title: '展示方式',
    //   description: '选择展开方式',
    //   setter: {
    ...
    // @Prop<checkboxGroupOptions<T, V, C>, 'min'>({
    //   group: '主要属性',
    //   title: '最小选中数',
    ...
    // @Prop<checkboxGroupOptions<T, V, C>, 'max'>({
    //   group: '主要属性',
    //   title: '最大选中数',
    ...
    //   description: '切换选项时触发',
    // })
    // onCheck: (event: { value: nasl.collection.List<V> | nasl.core.String; oldValue: nasl.collection.List<V> | nasl.core.String }) => any;
  ...
  export class CheckboxOptions<T, V> extends ViewComponentOptions {
    @Prop({
      title: '文本',
      description: '显示文本内容',
    })
