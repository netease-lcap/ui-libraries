...
namespace nasl.ui {
  ...
  export class UploaderOptions extends ViewComponentOptions {
    ...
    fileList: nasl.collection.List<nasl.core.String> = [] as any;
    ...
    @Prop({
      ...
      setter: {
        ...
        options: [{ title: '文本' }, { title: '图片' }, { title: '图片卡片' }, { title: '圆角图片卡片' }],
      },
    })
    ...
    url: nasl.core.String = 'url';

    // @Prop<UploaderOptions, 'fileIconSwitcher'>({
    //   group: '主要属性',
    //   title: '文件图标',
    ...
    // @Prop<UploaderOptions, 'downloadIconSwitcher'>({
    //   group: '主要属性',
    //   title: '下载图标',
    ...
    // @Prop<UploaderOptions, 'downloadIcon'>({
    //   group: '主要属性',
    //   title: '下载图标',
    //   setter: {
    //     concept: 'IconSetter',
    ...
    // @Prop<UploaderOptions, 'fixedCropper'>({
    //   group: '主要属性',
    //   title: '固定图片裁剪框大小',
    //   setter: {
    //     concept: 'SwitchSetter',
    ...
    // @Prop<UploaderOptions, 'cropperBoxWidth'>({
    //   group: '主要属性',
    //   title: '图片裁剪框宽度',
    //   setter: {
    //     concept: 'NumberInputSetter',
    ...
    // @Prop<UploaderOptions, 'cropperBoxHeight'>({
    //   group: '主要属性',
    //   title: '图片裁剪框高度',
    //   setter: {
    //     concept: 'NumberInputSetter',
    ...
    // @Prop<UploaderOptions, 'cropperPreviewShape'>({
    //   group: '主要属性',
    //   title: '图片裁剪框预览形状',
    //   setter: {
    //     concept: 'EnumSelectSetter',
    ...
    // @Prop<UploaderOptions, 'cropperTitle'>({
    //   group: '主要属性',
    //   title: '图片裁剪框标题',
    //   if: (_) => _.openCropper === true && _.multiple !== true,
    // })
    ...
    // @Prop<UploaderOptions, 'showFileList'>({
    //   group: '主要属性',
    //   title: '显示文件列表',
    ...
    onChange: (event: { file: nasl.core.String }) => any;
