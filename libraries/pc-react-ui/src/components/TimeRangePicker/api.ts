...
namespace nasl.ui {
  ...
  export class TimeRangePicker extends ViewComponent {
    constructor(options?: Partial<TimeRangePickerOptions & FormItemOptions>) {
      super();
    }
  }

  export class TimeRangePickerOptions extends ViewComponentOptions {
    // @Prop({
    //   group: '数据属性',
    //   title: '最小单位',
    //   description: '最小时间单位',
    ...
    @Prop<TimeRangePickerOptions, 'value'>({
      group: '数据属性',
      title: '值',
    ...
    // @Prop<TimePickerOptions, 'endTime'>({
    //   group: '数据属性',
    //   title: '结束值',
    ...
    // @Prop<TimePickerOptions, 'showFormatter'>({
    //   group: '主要属性',
    //   title: '时间展示格式',
    //   setter: {
    //     concept: 'EnumSelectSetter',
    ...
    // @Prop<TimePickerOptions, 'cancelTitle'>({
    //   group: '主要属性',
    //   title: '取消按钮名称',
    ...
    // @Prop<TimePickerOptions, 'okTitle'>({
    //   group: '主要属性',
    //   title: '确定按钮名称',
