  ...
  return `<VanLinearLayout direction="horizontal" wrap={true}>
    <VanTabs type="line">
      ...
      <VanTab slotTitle={
        ...
        <VanProcessInfo></VanProcessInfo>
      </VanTab>
      <VanTab slotTitle={
        <VanText text="审批记录"></VanText>
      }>
        <VanProcessRecord></VanProcessRecord>
      </VanTab>
    </VanTabs>
    <VanProcessButton style="position: fixed; left: 1px; width: 373px; bottom: 0px; height: 52px; z-index: 10;">
    </VanProcessButton>
  </VanLinearLayout>`;
}
