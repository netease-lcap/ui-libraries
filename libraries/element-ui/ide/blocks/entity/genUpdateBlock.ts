              ...
              onClick={
                  function ${nameGroup.viewLogicSubmit}(event) {
                      if ($refs.${nameGroup.viewElementMainView}.validate().valid) {
                          ${namespace}.${entity.name}Entity.update($refs.${nameGroup.viewElementMainView}.getFormData())
    ...
    const $lifecycles = {
        onMounted: [
            function ${nameGroup.viewLogicLoad}() {
                ...
                $refs.${nameGroup.viewElementMainView}.setFormData(${nameGroup.viewVariableEntity});
            },     
        ]      
    }
