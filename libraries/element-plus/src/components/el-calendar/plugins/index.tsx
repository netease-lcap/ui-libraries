...
const CalendarAccumulate = new PluginAccumulateTypes<
  nasl.ui.ElCalendarOptions<any, any, any, any, any>,
  CalendarProps
>();
  ...
  .addPlugin({
    ...
    handle: (props) => {
      ...
      return {
        slots: {
          ...slots,
          'date-cell': _.isFunction(dateCellSlot) ? dateCellSlot : dateCell,
        },
      };
    },
  });
