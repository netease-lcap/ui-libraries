...
import UploadContent from 'element-plus/es/components/upload/src/upload-content';
...
describe('<upload />', () => {
  ...
  //     const wrapper = mount(() => <UploadContent onExceed={onExceed} limit={1} />);
  ...
  //     const onStart = vi.fn();
  //     const wrapper = mount(() => <UploadContent onStart={onStart} autoUpload={false} />);
  ...
  //     const wrapper = mount(() => <UploadContent beforeUpload={beforeUpload} onRemove={onRemove} />);
  //     const fileList = [new File(['content'], 'test-file.txt')];
  //     mockGetFile(wrapper.find('input').element, fileList);
  ...
  //     const wrapper = mount(() => (
  //       <UploadContent data={data.value} multiple beforeUpload={beforeUpload} httpRequest={httpRequest} />
  //     ));
  ...
  //     const wrapper = mount(() => <UploadContent data={data} multiple httpRequest={httpRequest} />);
  ...
  //     const wrapper = mount(() => <UploadContent data={dataFN} multiple httpRequest={httpRequest} />);
  ...
  //       return Promise.resolve();
  //     });
  //     const wrapper = mount(<UploadContent httpRequest={httpRequest} onProgress={onProgress} />);
