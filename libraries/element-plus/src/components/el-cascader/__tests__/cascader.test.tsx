...
import { EVENT_CODE } from '@ep-test/constants';
...
describe('Cascader.vue', () => {
  test('toggle popper visible', async () => {
    ...
    const wrapper = _mount(() => <Cascader onVisibleChange={handleVisibleChange} />);
  ...
  test('expand and check', async () => {
    ...
    const wrapper = _mount(() => (
      <Cascader v-model={value.value} options={OPTIONS} onChange={handleChange} onExpandChange={handleExpandChange} />
    ));
  ...
  test('with default value', async () => {
    ...
    const wrapper = _mount(() => <Cascader v-model={value.value} options={OPTIONS} />);
  ...
  test('options change', async () => {
    ...
    const wrapper = _mount(() => <Cascader v-model={value.value} options={options.value} />);
  ...
  test('disabled', async () => {
    const handleVisibleChange = vi.fn();
    const wrapper = _mount(() => <Cascader disabled onVisibleChange={handleVisibleChange} />);
  ...
  test('clearable', async () => {
    ...
    const modval = ref(['zhejiang', 'hangzhou']);

    const wrapper = _mount(() => (
      <Cascader
        v-model={modval.value}
        clearable
        options={OPTIONS}
        onClear={() => {
          isClear.value = true;
    ...
    expect(wrapper.find('input').element.value).toBe('');
    expect(modval.value).toEqual(undefined);
  ...
  test('show last level label', async () => {
    const wrapper = _mount(() => (
      <Cascader modelValue={['zhejiang', 'hangzhou']} showAllLevels={false} options={OPTIONS} />
    ));
  ...
  test('tag type', async () => {
    const props = { multiple: true };
    const wrapper = _mount(() => (
      <Cascader modelValue={[['zhejiang', 'hangzhou']]} tagType="success" props={props} options={OPTIONS} />
    ));
  ...
  test('tag effect', async () => {
    const props = { multiple: true };
    const wrapper = _mount(() => (
      <Cascader modelValue={[['zhejiang', 'hangzhou']]} tagEffect="dark" props={props} options={OPTIONS} />
    ));
  ...
  describe('teleported API', () => {
    it('should mount on popper container', async () => {
      ...
      const value = ref([]);
      _mount(() => <Cascader v-model={value.value} filterable options={OPTIONS} />);
    ...
    it('should not mount on the popper container', async () => {
      expect(document.body.innerHTML).toBe('');
      const value = ref([]);
      _mount(() => <Cascader v-model={value.value} filterable teleported={false} options={OPTIONS} />);
  ...
  test('placeholder disappear when resetForm', async () => {
    ...
    const wrapper = _mount(() => (
      <ElForm model={model}>
        <ElFormItem label="Activty name" prop="name">
          <Cascader v-model={model.name} options={OPTIONS} filterable placeholder={AXIOM} />
        </ElFormItem>
      </ElForm>
    ));
  ...
  test('height should be changed by size when multiple', async () => {
    ...
    const props = { multiple: true };
    const wrapper = _mount(() => <Cascader props={props} size={cascaderSize.value} />);
    await nextTick();
  ...
  describe('render empty slot', () => {
    it('correct render panel empty slot', async () => {
      ...
      await wrapper.find(TRIGGER).trigger('click');
      const emptySlotEl = document.querySelector('.el-cascader-menu__empty-text');
