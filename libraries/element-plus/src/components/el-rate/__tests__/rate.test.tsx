...
import { ElRate as Rate } from '../index';
// import type { RateInstance } from '../src/rate';
type RateInstance = any;
...
describe('Rate.vue', () => {
  ...
  it('change event', () => {
    ...
    const wrapper = mount(() => <Rate v-model={value.value} onChange={handleChange} />);
  ...
  it('clearable', () => {
    ...
    const wrapper = mount(() => <Rate v-model={value.value} clearable onChange={handleChange} />);
