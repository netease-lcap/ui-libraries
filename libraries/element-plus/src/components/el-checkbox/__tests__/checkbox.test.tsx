...
//       const data = ref();
//       const onChange = (val: CheckboxValueType) => (data.value = val);
//       const wrapper = mount(() => <Checkbox v-model={checked.value} onChange={onChange} label="Foobar" />);
...
//       const checked = ref('a');
//       const wrapper = mount(() => <Checkbox label="Foobar" true-value="a" false-value={0} v-model={checked.value} />);
...
//   test('create', async () => {
//     const checked = ref(false);
//     const wrapper = mount(() => <CheckboxButton v-model={checked.value} label="a" value="a" />);
