...
import { ElDividerPlus as Divider } from '../index';
...
describe('Divider.vue', () => {
  ...
  test('line-dashed', () => {
    ...
    expect(getComputedStyle(wrapper.element, null).getPropertyValue('--el-border-style')).toBe('dashed');
  });

  test('line-solid', () => {
    const wrapper = mount(() => <Divider direction="vertical" />);
    expect(getComputedStyle(wrapper.element, null).getPropertyValue('--el-border-style')).toBe('solid');
  });
});
