...
import Affix from '@/components/el-affix/index';
...
describe('Affix.vue', () => {
  test('render test', async () => {
    ...
    const mockAffixRect = vi.spyOn(wrapper.find('.el-affix').element, 'getBoundingClientRect').mockReturnValue({
      height: 40,
      width: 1000,
      top: -100,
      bottom: -80,
  ...
  test('should render target props', async () => {
    ...
    const mockTargetRect = vi.spyOn(wrapper.find('.target').element, 'getBoundingClientRect').mockReturnValue({
      height: 200,
      width: 1000,
      top: -100,
      bottom: 100,
