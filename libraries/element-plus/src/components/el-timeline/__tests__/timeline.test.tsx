...
import type { TimelineItemProps } from 'element-plus/es/components/timeline';
import { ElTimeline as TimeLine, ElTimelineItem as TimeLineItem } from '../index';

// type TimelineItemProps = any;
