...
// import triggerEvent from 'element-plus/es/test-utils/trigger-event';
// import { rAF } from 'element-plus/es/test-utils/tick';
import { rAF, triggerEvent } from '@vue/test-utils';
...
// import { ElCheckbox as Checkbox } from 'element-plus/es/components/checkbox';
...
describe('Table.vue', () => {
  ...
  //   const { vm } = wrapper;
  //   await doubleWait();
  //   const checkGroup = vm.$el.querySelectorAll('.el-table__body-wrapper .el-checkbox-group');
  //   expect(checkGroup.length).toBe(3);
  //   const checkbox = vm.$el.querySelectorAll('.el-table__body-wrapper .el-checkbox');
  //   expect(checkbox.length).toBe(6);
  //   const checkSelect = vm.$el.querySelectorAll('.el-table__body-wrapper label.is-checked');
  ...
  describe('events', () => {
    ...
    //   const { vm } = wrapper;
    //   await doubleWait();
    //   const cell = vm.$el.querySelectorAll('.el-table__body-wrapper tbody tr')[0].querySelector('.el-table__cell');
  ...
  //     expect(lastCells.map((node) => node.text())).toEqual(['80', '92', '92', '95', '100']);
  //     await doubleWait();
  //     vm.testData = vm.testData.map((data) => Object.assign(data, { runtime: -data.runtime }));
  //     vm.$refs.table.sort('runtime', 'ascending');
  //     await doubleWait();
  //     expect(lastCells.map((node) => node.text())).toEqual(['-100', '-95', '-92', '-92', '-80']);
  //     wrapper.unmount();
  //   });
  ...
  //   await rAF();
  //   await doubleWait();
  //   const nodeLists = vm.$el.querySelectorAll('.el-table__body-wrapper tbody tr');
  ...
  //   const cellShouldContain = nodeLists[2].querySelectorAll('.el-table__cell')[0];
  ...
  describe('tree', () => {
    ...
    //   await doubleWait();
    //   expect(expandIcon.classes()).not.toContain('el-table__expand-icon--expanded');
    // });
  ...
  //   });
  //   await nextTick();
  //   expect(wrapper.find('.right').element.getAttribute('style')).toContain('min-width: 0');
  // });
  ...
  //   await rAF();
  //   expect(document.querySelector('.el-popper span')?.innerHTML).toContain(testData[0].name);
  //   expect(document.querySelector('.el-popper')?.getAttribute('aria-hidden')).toEqual('false');
  ...
  //   vi.useRealTimers();
  //   await rAF();
  //   expect(document.querySelector('.el-popper')?.getAttribute('aria-hidden')).toEqual('true');
  ...
  //   await rAF();
  //   expect(document.querySelector('.el-popper span')?.innerHTML).toContain(testData[1].name);
  ...
  //   expect(document.querySelector('.el-popper span')?.innerHTML).equals(`${testData[0].name}:formattered`);

  //   // From cell1 to cell2
  //   await childFormatterTds[1].trigger('mouseenter');
  //   await rAF();
  //   expect(document.querySelector('.el-popper span')?.innerHTML).equals(`${testData[0].director}:hello world`);
  //   await baseFormatterTds[2].trigger('mouseenter');
  //   await rAF();
  //   expect(document.querySelector('.el-popper span')?.innerHTML).equals(`${testData[1].name}:formattered`);
