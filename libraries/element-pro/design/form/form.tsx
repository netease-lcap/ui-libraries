...
export default mixins(classPrefixMixins).extend({
  ...
  methods: {
    ...
    async validate<T = Record<string, any>>(
      ...
      emitEvent<Parameters<ElFormProps['onValidate']>>(this, 'validate', {
    ...
    submitHandler<T>(e?: FormSubmitEvent) {
      ...
      this.validate<T>({ showErrorMessage: true }, 'submit-event').then((r) => {
        emitEvent<Parameters<ElFormProps['onSubmit']>>(this, 'submit', {
          validateResult: r,
    ...
    resetHandler(e?: FormResetEvent) {
      ...
      emitEvent<Parameters<ElFormProps['onReset']>>(this, 'reset', { e });
    },
    ...
    reset<T = FormData>(params: FormResetParams<T> = {}) {
      ...
      emitEvent<Parameters<ElFormProps['onReset']>>(this, 'reset', { e: undefined });
    },
