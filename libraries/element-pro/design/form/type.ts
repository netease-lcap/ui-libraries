...
import { ElNode, FormResetEvent, FormSubmitEvent } from '../common';

export interface ElFormProps<FormData extends Data = Data> {
  /**
   * 是否在表单标签字段右侧显示冒号
   * @default false
   */
   ...
   */
  statusIcon?: boolean | ElNode<ElFormItemProps>;
  /**
