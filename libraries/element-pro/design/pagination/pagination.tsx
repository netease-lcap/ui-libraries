import {
  PageFirstIcon as ElPageFirstIcon,
  PageLastIcon as ElPageLastIcon,
  ChevronLeftIcon as ElChevronLeftIcon,
  ChevronRightIcon as ElChevronRightIcon,
  ChevronLeftDoubleIcon as ElChevronLeftDoubleIcon,
  ChevronRightDoubleIcon as ElChevronRightDoubleIcon,
  EllipsisIcon as ElEllipsisIcon,
...
import ElInputAdornment from '../input-adornment';
...
export type PageSizeChangeParams = Parameters<ElPaginationProps['onPageSizeChange']>;
export type CurrentChangeParams = Parameters<ElPaginationProps['onCurrentChange']>;
export type ChangeEventParams = Parameters<ElPaginationProps['onChange']>;
...
export default mixins(getConfigReceiverMixins<Vue, PaginationConfig>('pagination'), getGlobalIconMixins()).extend({
  ...
  render() {
    const {
      ...
      PageFirstIcon: ElPageFirstIcon,
      PageLastIcon: ElPageLastIcon,
      ChevronLeftIcon: ElChevronLeftIcon,
      ChevronRightIcon: ElChevronRightIcon,
      ChevronLeftDoubleIcon: ElChevronLeftDoubleIcon,
      ChevronRightDoubleIcon: ElChevronRightDoubleIcon,
      EllipsisIcon: ElEllipsisIcon,
    });

    const Jumper = (
      <div class={this.jumperClass}>
        {this.t(this.global.jumpTo)}
        <el-input-adornment append={`/ ${this.pageCount} ${this.t(this.global.page)}`}>
          <el-input-number
