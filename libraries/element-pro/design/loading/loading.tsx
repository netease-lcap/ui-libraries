...
export default mixins(classPrefixMixins).extend({
  ...
  render() {
    ...
    const indicator = this.loading && renderElNodeJSX(this, 'indicator', defaultIndicator);
    const text = this.showText && <div class={`${this.classPrefix}-loading__text`}>{renderElNodeJSX(this, 'text')}</div>;
