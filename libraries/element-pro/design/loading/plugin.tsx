...
import { ElLoadingProps, LoadingInstance, LoadingMethod } from './type';
...
function createLoading(options: ElLoadingProps): LoadingInstance {
  const props = { ...options };
...
function produceLoading(props: boolean | ElLoadingProps): LoadingInstance {
  ...
  normalLoadingInstance = createLoading(props as ElLoadingProps);
