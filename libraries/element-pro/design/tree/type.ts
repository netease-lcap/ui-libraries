...
import { ElNode, TreeOptionData, TreeKeysType, ElScroll, ScrollToElementParams } from '../common';

export interface ElTreeProps<T extends TreeOptionData = TreeOptionData> {
  /**
   * 节点是否可高亮
   * @default false
   */
   ...
   * @default true
   */
  icon?: boolean | ElNode<TreeNodeModel<T>>;
  /**
   ...
   * @default true
   */
  label?: string | boolean | ElNode<TreeNodeModel<T>>;
  /**
   ...
   */
  operations?: ElNode<TreeNodeModel<T>>;
  /**
