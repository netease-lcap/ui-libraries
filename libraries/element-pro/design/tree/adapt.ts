...
import {
  ClassName, ElScroll, Styles, ElNode, TreeOptionData, ElNodeReturnValue,
} from '../common';
import { TypeTreeEventState as TreeEventState } from '../_common/js/tree/types';
import { ElTreeProps, TreeInstanceFunctions } from './type';
...
export { CaretRightSmallIcon as ElCaretRightSmallIcon } from '@element-ui-icons';
...
export type TypeScroll = ElScroll;
export type TypeStyles = Styles;
export type TypeElNode<T> = ElNode<T>;
export type TypeElNodeReturnValue = ElNodeReturnValue;
...
export type TreeProps<T extends TypeTreeOptionData = TypeTreeOptionData> = ElTreeProps<T> & {
  treeStore?: TreeStore;
};
