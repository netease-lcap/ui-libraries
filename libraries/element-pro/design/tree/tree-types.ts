...
import {
  ElTreeProps, TreeNodeModel, TreeNodeValue, TreeNodeState,
} from './type';
 ...
 * @deprecated
 */
export type TypeTreeProps<T extends TypeTreeOptionData = TypeTreeOptionData> = ElTreeProps<T>;

export type TypeElNodeState = TreeNodeState;
export type TypeElNodeValue = TreeNodeValue;
export type TypeTreeNode = TreeNode;
export type TypeTreeStore = TreeStore;
export type TypeValueMode = TreeProps['valueMode'];
export type TypeElNodeProp = boolean | string | TypeElNode<TypeTreeNodeModel>;
...
export interface TypeGetElNodeOption {
  node?: TreeNode;
  createElement?: TypeCreateElement;
}

export interface TypeRenderElNodeOption {
  node?: TypeTreeNodeModel;
}

export interface TypeScopedSlots {
  empty?: (opts?: TypeRenderElNodeOption) => TypeVNode;
  icon?: (opts?: TypeRenderElNodeOption) => TypeVNode;
  label?: (opts?: TypeRenderElNodeOption) => TypeVNode;
  line?: (opts?: TypeRenderElNodeOption) => TypeVNode;
  operations?: (opts?: TypeRenderElNodeOption) => TypeVNode;
}
