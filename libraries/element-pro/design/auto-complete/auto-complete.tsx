...
import { renderContent, renderElNodeJSX } from '../utils/render-tnode';
...
export default defineComponent({
  ...
  setup(props: ElAutoCompleteProps, { emit }) {
    ...
    const onInnerSelect: ElAutoCompleteProps['onSelect'] = (value, context) => {
  ...
  render() {
    ...
    const topContent = renderElNodeJSX(this, 'panelTopContent');
    const bottomContent = renderElNodeJSX(this, 'panelBottomContent');
