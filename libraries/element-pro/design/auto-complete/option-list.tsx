...
import { AutoCompleteOptionObj, ElAutoCompleteProps } from './type';
...
export default defineComponent({
  ...
  props: {
    ...
    value: String,
    size: String as PropType<ElAutoCompleteProps['size']>,
    options: Array as PropType<ElAutoCompleteProps['options']>,
    popupVisible: Boolean,
    highlightKeyword: Boolean,
    filterable: Boolean,
    filter: Function as PropType<ElAutoCompleteProps['filter']>,
  },
