...
export default defineComponent({
  ...
  render() {
    ...
    const labelContent = renderElNodeJSX('label');
    const prefixIconContent = renderElNodeJSX('prefixIcon');
    const suffixContent = renderElNodeJSX('suffix');
    const suffixIconContent = renderElNodeJSX('suffixIcon');
    const tips = renderElNodeJSX('tips');
