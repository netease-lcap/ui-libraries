...
import { DeleteIcon as ElDeleteIcon, AddIcon as ElAddIcon } from '@element-ui-icons';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const { DeleteIcon, AddIcon } = useGlobalIcon({ DeleteIcon: ElDeleteIcon, AddIcon: ElAddIcon });
