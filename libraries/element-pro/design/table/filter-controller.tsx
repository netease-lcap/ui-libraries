...
import { SearchIcon, FilterIcon as ElFilterIcon } from '@element-ui-icons';
...
export default defineComponent({
  ...
  setup(props: TableFilterControllerProps, { emit }) {
    ...
    const { FilterIcon } = useGlobalIcon({ FilterIcon: ElFilterIcon });
