...
import {
  BaseTableCellParams, RowspanColspan, TableRowData, ElBaseTableProps,
} from './type';
...
export interface TFootProps {
  ...
  footData: ElBaseTableProps['footData'];
  columns: ElBaseTableProps['columns'];
  rowAttributes: ElBaseTableProps['rowAttributes'];
  rowClassName: ElBaseTableProps['rowClassName'];
  // 表尾吸底内容宽度
  thWidthList?: { [colKey: string]: number };
  footerSummary?: ElBaseTableProps['footerSummary'];
  rowspanAndColspanInFooter: ElBaseTableProps['rowspanAndColspanInFooter'];
}
...
export default defineComponent({
  ...
  render() {
    ...
    const footerSummary = this.renderElNode('footerSummary');
    // 都不存在，则不需要渲染 footer
