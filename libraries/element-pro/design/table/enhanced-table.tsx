...
export default defineComponent({
  ...
  setup(props: ElEnhancedTableProps, context: SetupContext) {
    ...
    const onEnhancedTableRowClick: ElPrimaryTableProps['onRowClick'] = (p) => {
  ...
  render() {
    const props: ElPrimaryTableProps = {
