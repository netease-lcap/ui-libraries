...
import { ElBaseTableProps, TableRowData } from '../type';
...
export function usePaginationValue(
  ...
  onPageChange: ElBaseTableProps['onPageChange'],
): [Ref<PaginationProps>, Ref<ElBaseTableProps['onPageChange']>] {
  if (
...
export default function usePagination(props: ElBaseTableProps, context: SetupContext) {
