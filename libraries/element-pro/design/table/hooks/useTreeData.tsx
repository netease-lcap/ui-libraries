...
import { AddRectangleIcon as ElAddRectangleIcon, MinusRectangleIcon as ElMinusRectangleIcon } from '@element-ui-icons';
import get from 'lodash/get';
import { CreateElement } from 'vue';
import TableTreeStore, { SwapParams } from '../../_common/js/table/tree-store';
import {
  ElEnhancedTableProps,
  PrimaryTableCol,
  TableRowData,
  TableRowValue,
  TableRowState,
...
export default function useTreeData(props: ElEnhancedTableProps, context: SetupContext) {
  ...
  function getFoldIcon(h: CreateElement, context: PrimaryTableCellParams<TableRowData>) {
    ...
    return renderElNode('treeExpandAndFoldIcon', {
