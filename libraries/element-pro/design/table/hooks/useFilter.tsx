...
import {
  ElPrimaryTableProps, PrimaryTableCol, TableRowData, FilterValue, TableFilterChangeContext,
} from '../type';
import useDefaultValue from '../../hooks/useDefaultValue';
import { useElNodeDefault } from '../../hooks/tnode';
import ElTableFilterController from '../filter-controller';
...
export default function useFilter(props: ElPrimaryTableProps, context: SetupContext) {
  ...
  function renderFirstFilterRow(h: CreateElement) {
    ...
    const defaultNode = (
      <div class={tableFilterClasses.result}>
        ...
        <ElButton theme="primary" variant="text" onClick={onResetAll}>
          {global.value.clearFilterResultButtonText}
        </ElButton>
      </div>
    );
    const filterContent = renderElNode('filterRow');
