...
import {
  BaseTableCol, PrimaryTableCol, TableRowData, ElBaseTableProps,
} from '../type';
...
export default function useTableHeader(props: ElBaseTableProps) {
  ...
  const renderTitleWidthIcon = (
    h: CreateElement,
    [title, sortIcon, filterIcon]: ElNodeReturnValue[],
