...
export interface RenderElExtra {
  ...
  cellEmptyContent: ElBaseTableProps['cellEmptyContent'];
}
...
export type TrCommonProps = Pick<ElPrimaryTableProps, TrPropsKeys>;
...
export default defineComponent({
  ...
  methods: {
    ...
    renderEl(h: CreateElement, params: BaseTableCellParams<TableRowData>, extra: RenderElExtra) {
