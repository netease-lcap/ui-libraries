...
import { AttachNode, ElNode } from '../common';
import { renderContent } from '../utils/render-tnode';
import { isNodeOverflow } from '../utils/dom';
import ElTooltip, { TooltipProps } from '../tooltip';

export interface EllipsisProps {
  content?: string | ElNode;
  default?: string | ElNode;
  tooltipContent?: string | number | ElNode;
...
export default defineComponent({
  ...
  render() {
    ...
    if (this.isOverflow) {
      ...
      content = <ElTooltip props={rProps}>{ellipsisContent}</ElTooltip>;
    } else {
