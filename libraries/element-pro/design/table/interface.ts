...
export interface BaseTableProps extends ElBaseTableProps {
  /**
...
export type PrimaryTableProps = ElPrimaryTableProps;
export type EnhancedTableProps = ElEnhancedTableProps;
export type TableProps = PrimaryTableProps;

export type ThRowspanAndColspan = Map<any, RowspanColspan>;

export type BaseTableColumns = ElBaseTableProps['columns'];
