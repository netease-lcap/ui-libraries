...
import {
  CellData, RowClassNameParams, TableColumnClassName, TableRowData, ElBaseTableProps,
} from './type';
...
// 行属性
export function formatRowAttributes(attributes: ElBaseTableProps['rowAttributes'], params: FormatRowAttributesParams) {
...
export function formatRowClassNames(
  rowClassNames: ElBaseTableProps['rowClassName'],
