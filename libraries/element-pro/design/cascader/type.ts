...
import { ElNode, TreeOptionData, SizeEnum, TreeKeysType } from '../common';

export interface ElCascaderProps<CascaderOption extends TreeOptionData = TreeOptionData> {
  /**
   * 自动聚焦
   */
  autofocus?: boolean;
   ...
   * 自定义单个级联选项
   */
  option?: ElNode<{ item: CascaderOption; index: number }>;
  /**
   * 可选项数据源
   * @default []
   */
