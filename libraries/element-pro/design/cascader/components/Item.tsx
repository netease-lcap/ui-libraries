...
import { ChevronRightIcon as ElChevronRightIcon } from '@element-ui-icons';
...
import {
  CascaderContextType, TreeNodeValue, TreeNode, ElCascaderProps,
} from '../interface';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const { ChevronRightIcon } = useGlobalIcon({ ChevronRightIcon: ElChevronRightIcon });
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {node.children
          && (node.loading ? <ElLoading class={iconClass} size="small" /> : <ChevronRightIcon class={iconClass} />)}
      </li>
    );
  },
});
