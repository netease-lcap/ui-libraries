...
export const useContext = (
  ...
  setInnerValue: ElCascaderProps['onChange'],
  innerPopupVisible: Ref<ElCascaderProps['popupVisible']>,
  setPopupVisible: ElCascaderProps['onPopupVisibleChange'],
) => {
...
// 内聚组件核心的副作用与状态处理
export const useCascaderContext = (props: ElCascaderProps) => {
