...
import { ElNode, ClassName } from '../common';
import props from './props';
import InputNumber from '../input-number/index';
import ElSliderMark from './slider-mark';
import { SliderValue, ElSliderProps } from './type';
...
export interface MarkItem {
  point: number;
  position: number;
  mark: string | number | ElNode<{ value: number }>;
}
...
export default mixins(classPrefixMixins).extend({
  ...
  methods: {
    ...
    emitChange(value: SliderValue) {
      ...
      emitEvent<Parameters<ElSliderProps['onChange']>>(this, 'change', fixValue);
    },
    emitChangeEnd() {
