...
import { ElTooltipProps } from '../tooltip/type';
...
export default mixins(classPrefixMixins, Vue as VueConstructor<SliderInstanceType>).extend({
  ...
  props: {
    value: {
      type: [Number, String] as PropType<ElSliderProps['value']>,
      default: 0,
    },
    vertical: {
      type: Boolean,
    ...
    tooltipProps: {
      type: [Boolean, Object] as PropType<ElSliderProps['tooltipProps']>,
      default: true,
    },
    label: {
      type: [String, Function, Boolean] as PropType<ElSliderProps['label']>,
      default: true,
    },
    range: {
      type: Boolean,
  ...
  methods: {
    getTooltipContent() {
      ...
      return renderElNodeJSX(this, 'label', {
        params: this.range
          ? {
            value: this.value,
    ...
    getTooltipProps(): ElTooltipProps {
      if (this.tooltipProps instanceof Object) {
