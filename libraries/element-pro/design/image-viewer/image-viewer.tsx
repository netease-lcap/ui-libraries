...
import { ChevronLeftIcon, ChevronDownIcon, CloseIcon } from '@element-ui-icons';
import props from './props';
import Container from './base/Container';
import ElImageViewerIcon from './base/ImageModalIcon';
import ElImageViewerUtils from './base/ImageViewerUtils';
import ElImageItem from './base/ImageItem';
import ElImageViewerModal from './base/ImageViewerModal';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const onCloseHandle: ElImageViewerProps['onClose'] = (ctx) => {
  ...
  methods: {
    ...
    renderCloseBtn() {
      ...
      return (
        ...
        >
          {renderElNodeJSX(this, 'closeBtn', <CloseIcon size="24px" />)}
        </div>
      );
    },
    renderViewer() {
  ...
  render() {
    return (
      <Container ref="containerRef" mode={this.mode} renderModal={this.renderModal} renderViewer={this.renderViewer}>
        {renderElNodeJSX(this, 'trigger', { params: { open: this.openHandler } })}
      </Container>
    );
  },
});
