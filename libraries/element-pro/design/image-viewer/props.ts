...
export default {
  ...
  closeBtn: {
    type: [Boolean, Function] as PropType<ElImageViewerProps['closeBtn']>,
    default: true,
  },
  ...
  imageScale: {
    type: Object as PropType<ElImageViewerProps['imageScale']>,
  },
  ...
  images: {
    type: Array as PropType<ElImageViewerProps['images']>,
    default: (): ElImageViewerProps['images'] => [],
  },
  /** 当前预览图片所在的下标 */
  index: {
    type: Number,
  ...
  mode: {
    type: String as PropType<ElImageViewerProps['mode']>,
    default: 'modal' as ElImageViewerProps['mode'],
    validator(val: ElImageViewerProps['mode']): boolean {
      if (!val) return true;
  ...
  /** 切换预览图片的左图标，可自定义 */
  navigationArrow: {
    type: [Boolean, Function] as PropType<ElImageViewerProps['navigationArrow']>,
    default: true,
  },
  ...
  /** 预览标题 */
  title: {
    type: [String, Function] as PropType<ElImageViewerProps['title']>,
  },
  /** 触发图片预览的元素，可能是一个预览按钮，可能是一张缩略图，完全自定义 */
  trigger: {
    type: [String, Function] as PropType<ElImageViewerProps['trigger']>,
  },
  ...
  onClose: Function as PropType<ElImageViewerProps['onClose']>,
  /** 预览图片切换时触发，`context.prev` 切换到上一张图片，`context.next` 切换到下一张图片 */
  onIndexChange: Function as PropType<ElImageViewerProps['onIndexChange']>,
};
