...
export interface ElTagInputProps {
  /**
   * 宽度随内容自适应
   * @default false
   */
   ...
   */
  tag?: string | ElNode<{ value: string | number }>;
  /**
   * 透传 Tag 组件全部属性
   */
  tagProps?: TagProps;
   ...
   */
  valueDisplay?: string | ElNode<{ value: TagInputValue; onClose: (index: number, item?: any) => void }>;
  /**
   * 失去焦点时触发
   */
