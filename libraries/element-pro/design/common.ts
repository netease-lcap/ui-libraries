...
export type ElNodeReturnValue = import('vue/types/vnode').ScopedSlotReturnValue;
export type ElNode<T = undefined> = T extends undefined
  ? (h: Vue.CreateElement) => ElNodeReturnValue
  : (h: Vue.CreateElement, props: T) => ElNodeReturnValue;

export type JsxNode = ElNodeReturnValue;
...
/**
 * @deprecated use ElScroll instead
 */
export type InfinityScroll = ElScroll;
