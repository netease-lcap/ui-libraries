...
import { ElNode, Styles, AttachNode } from '../common';
...
export interface ElDialogProps {
   ...
   */
  confirmBtn?: string | ButtonProps | ElNode | null;
  /**
   * 确认按钮加载状态
   */
...
export interface ElDialogCardProps
  extends Pick<
    ElDialogProps,
    | 'body'
    | 'cancelBtn'
...
export interface DialogOptions extends Omit<ElDialogProps, 'attach'> {
  /**
   * 对话框挂载的节点。数据类型为 String 时，会被当作选择器处理，进行节点查询。示例：'body' 或 () => document.body
   * @default 'body'
   */
