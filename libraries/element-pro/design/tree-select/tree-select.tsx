...
import { TreeSelectValue, ElTreeSelectProps } from './type';
import { useElNodeJSX, useElNodeDefault } from '../hooks/tnode';
...
export default defineComponent({
  ...
  setup(props: ElTreeSelectProps, context) {
    const renderElNodeJSX = useElNodeJSX();
    const renderDefaultElNode = useElNodeDefault();
  ...
  methods: {
    ...
    renderLabel() {
      const label = this.renderElNodeJSX('label');
      const prefixIcon = this.renderElNodeJSX('prefixIcon');
      if (label && prefixIcon) {
        return (
          <div>
            {label}
    ...
    getTreePanel() {
      return (
        ...
        >
          ...
          {!this.loading ? (
            <Tree
              ...
              props={{
                ...
                empty: () => this.renderDefaultElNode('empty', {
          ...
          {this.renderElNodeJSX('panelBottomContent')}
        </div>
      );
    },
  },
        ...
        {...{
          props: {
            ...
            popupProps: {
              ...
              ...(this.popupProps as ElTreeSelectProps['popupProps']),
            },
            inputProps: {
              size: this.size,
              ...(this.inputProps as ElTreeSelectProps['inputProps']),
            },
            tagInputProps: {
              size: this.size,
            },
            tagProps: {
              maxWidth: 300,
              ...(this.tagProps as ElTreeSelectProps['tagProps']),
            },
            ...
            valueDisplay: () => this.renderElNodeJSX('valueDisplay', {
