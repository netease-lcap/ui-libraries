...
import { ElNode, TreeOptionData, TreeKeysType } from '../common';

export interface ElTreeSelectProps<
...
> {
   ...
   * 自定义选中项呈现方式
   */
  valueDisplay?: string | ElNode<{ value: TreeOptionData | TreeOptionData[]; onClose: (index: number) => void }>;
  /**
