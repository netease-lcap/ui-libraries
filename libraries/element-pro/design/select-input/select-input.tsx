...
export default defineComponent({
  ...
  setup(props: ElSelectInputProps, context: SetupContext) {
    ...
    function onInnerBlur(ctx: PopupVisibleChangeContext) {
      ...
      const params: Parameters<ElSelectInputProps['onBlur']>[1] = { e: ctx.e, inputValue };
  ...
  render(h) {
    ...
    const tipsNode = renderElNodeJSX(this, 'tips');
    return (
