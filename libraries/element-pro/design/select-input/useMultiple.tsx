...
import Vue from 'vue';
import { ElSelectInputProps, SelectInputKeys } from './type';
...
export default function useMultiple(props: ElSelectInputProps, context: SetupContext) {
  ...
  const onInputChange: TagInputProps['onInputChange'] = (val, ctx) => {
    ...
    setElInputValue(val, { trigger: ctx.trigger, e: ctx.e });
  };
