...
import { ImageErrorIcon, ImageIcon } from '@element-ui-icons';
...
export default defineComponent({
  ...
  methods: {
    renderPlaceholder() {
      const placeholder = renderElNodeJSX(this, 'placeholder');
    ...
    renderOverlay() {
      const overlay = renderElNodeJSX(this, 'overlayContent');
