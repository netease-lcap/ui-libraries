...
import {
  ...
  ElDateRangePickerPanelProps,
  DatePickerYearChangeTrigger,
  DatePickerMonthChangeTrigger,
} from './type';

import ElRangePanel from './panel/RangePanel';
...
export default defineComponent({
  ...
  setup(props: ElDateRangePickerPanelProps, { emit, attrs }) {
    const {
  ...
  render() {
    ...
    return <ElRangePanel {...{ props: panelProps }} />;
  },
});
