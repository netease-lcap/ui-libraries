...
import type { ElDatePickerProps, ElDateRangePickerProps } from '../type';

export interface disableDateProps {
  disableDate?: ElDatePickerProps['disableDate'] | ElDateRangePickerProps['disableDate'];
  format?: ElDatePickerProps['format'];
  mode?: ElDatePickerProps['mode'];
  start?: Date;
  end?: Date;
}
