...
export interface ElCheckboxGroupProps<T = CheckboxGroupValue> {
  /**
...
export interface CheckboxOptionObj extends ElCheckboxProps {
  text?: string;
}
...
export interface CheckboxGroupChangeContext {
  ...
  option: CheckboxOption | ElCheckboxProps;
  type: 'check' | 'uncheck';
}
