...
export default {
  ...
  /** 多选框内容，同 label */
  default: {
    type: [String, Function] as PropType<ElCheckboxProps['default']>,
  },
  ...
  /** 多选框的值 */
  value: {
    type: [String, Number, Boolean] as PropType<ElCheckboxProps['value']>,
  },
  /** 值变化时触发 */
  onChange: Function as PropType<ElCheckboxProps['onChange']>,
};
