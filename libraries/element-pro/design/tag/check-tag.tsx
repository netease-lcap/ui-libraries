...
import Tag from './tag';
import { ElCheckTagProps, ElTagProps } from './type';
...
export default defineComponent({
  ...
  setup(props: ElCheckTagProps, context) {
    ...
    const checkTagProps = computed(() => {
      const checkedProps: ElTagProps = { theme: 'primary', ...props.checkedProps };
      const uncheckedProps: ElTagProps = { ...props.uncheckedProps };
