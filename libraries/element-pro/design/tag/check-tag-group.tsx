...
import {
  CheckTagGroupOption, CheckTagGroupValue, ElCheckTagProps, ElCheckTagGroupProps,
} from './type';

export default defineComponent({
  name: 'ElCheckTagGroup',

  props,

  setup(props: ElCheckTagGroupProps, context) {
    ...
    const onCheckTagChange: ElCheckTagProps['onChange'] = (checked, ctx) => {
      const { value } = ctx;
      if (checked) {
        if (props.multiple) {
