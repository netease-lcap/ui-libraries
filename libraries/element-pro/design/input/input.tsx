...
import {
  ...
  BrowseOffIcon as ElBrowseOffIcon,
...
export default mixins(
    ...
    value: {
      handler(val) {
        ...
        if (newVal !== val && this.type !== 'number') {
          emitEvent<Parameters<ElInputProps['onChange']>>(this, 'change', newVal, { trigger: 'initial' });
        }
      },
      immediate: true,
    },
  ...
  methods: {
    ...
    handleKeydown(e: KeyboardEvent) {
      ...
      if (/enter/i.test(e.key) || /enter/i.test(e.code)) {
        emitEvent<Parameters<ElInputProps['onEnter']>>(this, 'enter', tmpValue, { e });
      } else {
        emitEvent<Parameters<ElInputProps['onKeydown']>>(this, 'keydown', tmpValue, { e });
      }
    },
    handleKeyUp(e: KeyboardEvent) {
      ...
      const tmpValue = this.getOutputValue(value);
      emitEvent<Parameters<ElInputProps['onKeyup']>>(this, 'keyup', tmpValue, { e });
    },
    handleKeypress(e: KeyboardEvent) {
      ...
      const tmpValue = this.getOutputValue(value);
      emitEvent<Parameters<ElInputProps['onKeypress']>>(this, 'keypress', tmpValue, { e });
    },
    handlePaste(e: ClipboardEvent) {
      if (this.tDisabled) return;
      // @ts-ignore
      const clipData = e.clipboardData || window.clipboardData;
      emitEvent<Parameters<ElInputProps['onPaste']>>(this, 'paste', { e, pasteValue: clipData?.getData('text/plain') });
    },

    onHandleMousewheel(e: WheelEvent) {
      emitEvent<Parameters<ElInputProps['onWheel']>>(this, 'wheel', { e });
    },
    ...
    emitClear(e: MouseEvent) {
      ...
      emitEvent<Parameters<ElInputProps['onChange']>>(this, 'change', val, { e, trigger: 'clear' });
      emitEvent<Parameters<ElInputProps['onClear']>>(this, 'clear', { e });
    },
    emitFocus(e: FocusEvent) {
      this.inputValue = this.value;
      if (this.tDisabled) return;
      this.focused = true;
      emitEvent<Parameters<ElInputProps['onFocus']>>(this, 'focus', this.value, { e });
    },
    formatAndEmitBlur(e: FocusEvent) {
      ...
      emitEvent<Parameters<ElInputProps['onBlur']>>(this, 'blur', this.value, { e });
    },
    ...
    handleInput(e: InputEvent | CompositionEvent) {
      ...
      if (this.composingRef) {
        ...
        emitEvent<Parameters<ElInputProps['onChange']>>(this, 'change', val, { e, trigger: 'input' });
    ...
    onInputMouseenter(e: MouseEvent) {
      this.isHover = true;
      emitEvent<Parameters<ElInputProps['onMouseenter']>>(this, 'mouseenter', { e });
    },

    onInputMouseleave(e: MouseEvent) {
      this.isHover = false;
      emitEvent<Parameters<ElInputProps['onMouseleave']>>(this, 'mouseleave', { e });
    },
  ...
  render(h: CreateElement): VNode {
    ...
    const label = renderElNodeJSX(this, 'label');
    const suffix = renderElNodeJSX(this, 'suffix');
    ...
    const tips = renderElNodeJSX(this, 'tips');
