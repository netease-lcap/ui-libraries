...
// console.log(components.map(item => item.subs), components0.map(item => item.subs));

fs.writeFileSync(path.join(__dirname, './1.json'), JSON.stringify(components, null, 2));
fs.writeFileSync(path.join(__dirname, './0.json'), JSON.stringify(components0, null, 2));
